		        	...
		        	<div class="content col-xs-10 col-xs-offset-1">
						<div class="title">
							 <span class="listtitle h2">
							 	我的物资捐助记录
							 	<span class="badge">${my_goodsnum}件</span>
							 </span>	
						</div>
					</div>
	        	</div>
	        	<div class="row col-xs-8 col-xs-offset-2">
	        	<c:forEach items="${my_goodss}" var="goods">
	        		<div class="proj_content">   
		        		 <div class="content">    
			        		 <i class="greenspot beBig"></i>  
			        		 <!-- 项目名 -->      
			        		 <p class="name" style="margin-bottom:0;">参与的项目名称：<span>${goods.pro_Title }</span></p>
			        		 <!-- 捐助物品名 -->	
			        		 <p class="text-muted" style="margin-bottom:0;">该次捐助的物品：<span class="text-red">${goods.go_Name }</span> </p>
			        		 <!-- 捐助件数 -->			        		 
			        		 <p class="text-muted">该次捐助的件数：<span class="text-red">${goods.go_Number }</span> 件</p>
			        		  <!-- 捐助时间 -->       
			        		 <p class="text-muted">${goods.do_Time}</p>  
		        		 </div>  
	        		 </div>
	        	</c:forEach>    	
	       		</div>	        	
